...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local     staged='%F{#a6e3a1}'  # green foreground
      local     commit='%F{#94e2d5}'  # teal foreground (commit hash)
      ...
      local     staged='%F{#9399b2}'  # grey foreground
      local     commit='%F{#9399b2}'  # grey foreground
    ...
    # [[ -z $VCS_STATUS_LOCAL_BRANCH && -z $VCS_STATUS_TAG ]] &&  # <-- this line
      res+="${meta} @ ${commit}${VCS_STATUS_COMMIT[1,8]}"
  ...
  typeset -g POWERLEVEL9K_KUBECONTEXT_CLASSES=(
      '*prod*'  PROD       # production contexts/namespaces -> red (safety)
      '*stag*'  STAGING    # staging -> yellow
      '*'       DEFAULT)   # everything else -> mauve
  typeset -g POWERLEVEL9K_KUBECONTEXT_DEFAULT_FOREGROUND=$P10K_COLOR_MAUVE
  typeset -g POWERLEVEL9K_KUBECONTEXT_PROD_FOREGROUND=$P10K_COLOR_RED
  typeset -g POWERLEVEL9K_KUBECONTEXT_STAGING_FOREGROUND=$P10K_COLOR_YELLOW
  ...
  # Turn the whole segment red when the project contains "prod" (safety), like kubecontext.
  typeset -g POWERLEVEL9K_GCLOUD_PARTIAL_CONTENT_EXPANSION='${${(M)P9K_GCLOUD_PROJECT_ID:#*prod*}:+%F{#f38ba8\}}${P9K_GCLOUD_PROJECT_ID//\%/%%}'
  typeset -g POWERLEVEL9K_GCLOUD_COMPLETE_CONTENT_EXPANSION='${${(M)P9K_GCLOUD_PROJECT_NAME:#*prod*}:+%F{#f38ba8\}}${P9K_GCLOUD_PROJECT_NAME//\%/%%}'
  # Also turn the icon red on prod (the content color does not affect the icon).
  typeset -g POWERLEVEL9K_GCLOUD_PARTIAL_VISUAL_IDENTIFIER_EXPANSION='${${(M)P9K_GCLOUD_PROJECT_ID:#*prod*}:+%F{#f38ba8\}}${P9K_VISUAL_IDENTIFIER}'
  typeset -g POWERLEVEL9K_GCLOUD_COMPLETE_VISUAL_IDENTIFIER_EXPANSION='${${(M)P9K_GCLOUD_PROJECT_NAME:#*prod*}:+%F{#f38ba8\}}${P9K_VISUAL_IDENTIFIER}'
